...
<head>
  ...
  <title>Manuu Addmission Management System
  </title>
...
data-open="click" data-menu="vertical-menu" data-col="1-column">
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="../index.php">
              ...
              <h3 class="brand-text">Manuu Admission Management System  | User Signup</h3>
            </a>
          </li>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0 pb-0">
                  <div class="card-title text-center">
                   <h4 style="font-weight: bold"> MAMS User Signup</h4>
                  </div>
  ...
  <footer class="footer fixed-bottom footer-dark navbar-border navbar-shadow">
    <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
      <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2023 <a class="text-bold-800 grey darken-2" >MAMS </a>, All rights reserved. </span>
    </p>
  </footer>
